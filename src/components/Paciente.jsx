...
const Paciente = ({paciente, setPaciente}) => {
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      <p className="font-bold mb-3 text-gay-700">Nombre:{' '}
          <span className="font-normal normal case">{nombre}</span>
      </p>
      <p className="font-bold mb-3 text-gay-700">Propietario:{' '}
          <span className="font-normal normal case">{propietario}</span>
      </p>
      <p className="font-bold mb-3 text-gay-700">Email:{' '}
          <span className="font-normal normal case">{email}</span>
      </p>
      <p className="font-bold mb-3 text-gay-700">Fecha Alta:{' '}
          <span className="font-normal normal case">{fecha}</span>
      </p>
      <p className="font-bold mb-3 text-gay-700">Síntomas:{' '}
